...
| Type | Engines | What it reflects |
|---|---|---|
| **Online** | ChatGPT (web), Copilot, Perplexity, AI Overviews, Grok | Current web presence, recent content |
| **Offline** | ChatGPT (no web), Gemini, Claude, Mistral, DeepSeek | Historical brand authority, training data |

<Info>
**Online metrics** can improve quickly with new content and SEO. **Offline metrics** change slowly and reflect long-term brand authority.
</Info>
