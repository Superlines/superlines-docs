...
description: Connect AI assistants like Claude and Cursor to your Superlines analytics data — and manage your account.
---
...
The MCP server exposes **32 specialized tools** across these categories:
