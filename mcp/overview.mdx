...
description: Connect AI assistants like Claude, Cursor, Windsurf, Lovable, and ChatGPT to your Superlines analytics data — and manage your account.
---
...
This means you can **ask questions about your AI search visibility data in natural language** and **manage your brands and prompts** directly from Claude, Cursor, Windsurf, Lovable, ChatGPT, VS Code, or any MCP-compatible client.
...
- **MCP client** — Claude (Desktop, Code, or claude.ai), Cursor, Windsurf, Lovable, ChatGPT, VS Code, or any MCP-compatible application
