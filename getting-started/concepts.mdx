...
- **Brand position** — in what order is your brand mentioned relative to others?
...
<Note>
Not all AI engines provide citations. Models with web access (like Perplexity, Copilot, Google AI Overviews, Google AI Mode) cite sources more often than offline models.
</Note>
...
<Steps>
  ...
  <Step title="Metrics are calculated">
    Brand Visibility, Citation Rate, Share of Voice, Average Position, and more.
  </Step>
