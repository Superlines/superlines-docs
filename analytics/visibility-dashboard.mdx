...
- Toggle **Only my competitors** to filter the view — **on by default**, showing only your configured competitors plus your own brand; switch it off to rank all brands detected in AI responses
- Export as CSV or JSON

<Info>
The **Industry Average** shown here (and referenced on the KPI cards) is the unweighted mean across the top 10 brands currently shown in this table, and it always includes your own brand. Changing the toggle changes which brands feed the average. See [Key Metrics](/metrics/key-metrics) for details.
</Info>
