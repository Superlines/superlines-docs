...
- **Prompt labels** — filter all mention data to only prompts tagged with one or more labels. Labels are assigned to prompts in [Prompt Management](/analytics/prompts). The filter appears automatically once you have labeled prompts.
